...
def populate_data():
    trip = add_trip("Trip to Barcelona", "A 5-day trip to Barcelona, exploring its beautiful architecture and vibrant culture")
    ...
    day4 = add_day(trip, 4)
    add_event(day4, "Check in at Hotel Arts Barcelona", "Accommodation", "12:00", "Hotel Arts Barcelona", 200, "Enjoy a luxurious stay at Hotel Arts Barcelona with a beautiful view of the city")
    add_event(day4, "Take a metro to the Magic Fountain of Montjuïc", "Transportation", "18:00", "Barcelona Metro", 5, "Experience the efficient metro system of Barcelona")
    add_event(day4, "Visit Magic Fountain of Montjuïc", "Entertainment", "20:00", "Magic Fountain of Montjuïc, Barcelona", 0, "Enjoy a spectacular display of color, light, motion, music and water acrobatics")

    day5 = add_day(trip, 5)
    add_event(day5, "Take a taxi to the airport", "Transportation", "10:00", "Barcelona Airport", 30, "Return journey to the airport")
    add_event(day5, "Buy souvenirs at Duty Free", "Misc", "12:00", "Barcelona Airport", 100, "Get some souvenirs and gifts for your loved ones at Duty Free")
    ...
    add_event(day1_japan, "Visit Senso-ji Temple", "Entertainment", "10:00", "Senso-ji Temple, Tokyo", 10, "Visit the oldest temple in Tokyo, Senso-ji Temple, located in the Asakusa district")
    ...
    add_event(day2_japan, "Visit Odaiba", "Entertainment", "15:00", "Odaiba, Tokyo", 20, "Enjoy the sights and attractions of Odaiba, a popular shopping and entertainment district on a man-made island in Tokyo Bay")
    ...
    add_event(day4_japan, "Check in at The Ritz-Carlton, Tokyo", "Accommodation", "14:00", "The Ritz-Carlton, Tokyo", 350, "Stay at The Ritz-Carlton, Tokyo, an opulent hotel offering a stunning view of the city")
    add_event(day4_japan, "Take a metro to Roppongi Hills", "Transportation", "16:00", "Tokyo Metro", 3, "Navigate through Tokyo's comprehensive metro system")
    add_event(day4_japan, "Explore Roppongi Hills", "Entertainment", "17:00", "Roppongi Hills, Tokyo", 0, "Experience the modern side of Tokyo at Roppongi Hills, a complex with shops, restaurants, and a museum")

    day5_japan = add_day(trip_japan, 5)
    add_event(day5_japan, "Take a taxi to the airport", "Transportation", "10:00", "Narita International Airport", 50, "Return journey to the airport")
    add_event(day5_japan, "Buy souvenirs at Duty Free", "Misc", "12:00", "Narita International Airport", 100, "Get some souvenirs and gifts for your loved ones at Duty Free")
